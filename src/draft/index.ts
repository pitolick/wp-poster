...
import { validateFrontmatter, type DraftFrontmatter, type ValidateOptions } from './schema.js';
 ...
 */
export function parseDraft(markdown: string, options: ValidateOptions = {}): ParseDraftResult {
